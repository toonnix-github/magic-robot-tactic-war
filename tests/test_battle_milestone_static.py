...
class BattleMilestoneStaticTests(unittest.TestCase):
    ...
    def test_phase2_hangar_front_mission_layout_and_telemetry(self):
        ...
        self.assertIn("category_btn_part", editor_source)
        self.assertIn("category_btn_weapon", editor_source)
        self.assertIn("stats_tab_combat", editor_source)
        self.assertIn("stats_tab_parts", editor_source)
        self.assertIn("func _select_stats_tab", editor_source)
        self.assertIn("MECH STATUS", editor_source)
